...
if __name__ == "__main__":
    ...
    parser.add_argument("file_name",
                        help="Enter the name or path of desired image")

    parser.add_argument("width",
                        help="Enter the size of desired width by pixels", type=int)

    parser.add_argument("--grid_off",
                        default=True,
                        action="store_false",
    ...
    parser.add_argument('--debug',
                        action='store_true',
                        help="Turns on the debugging outputs")
